...
- [Вариант установки и запуска приложения через Ubuntu (Andronix)](#вариант-установки-и-запуска-приложения-через-ubuntu-andronix)
...
- [Подключение ПК к телефону по SSH](#подключение-пк-к-телефону-по-ssh)
